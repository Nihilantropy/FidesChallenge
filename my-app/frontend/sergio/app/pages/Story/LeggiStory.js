            ...
            <ScrollView>
                <View style={[styles.box]}>
                    ...
                    <View style={[{alignSelf: 'flex-start'}]}>    
                        { storia.author_visible == true && (<Text style={styles.testi}>Il tuo nickname e' visibile</Text>) }
                        { storia.author_visible == false && (<Text style={styles.testi}>Il tuo nickname e' oscurato</Text>) }
                    </View>
                    <Text>{"\n"}</Text>
