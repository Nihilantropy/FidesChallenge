...
const runMigrations = async () => {
    try {
        ...
        /*
            Uncomment this section to make the migration act like a db-reset
            This will rollback all the tables, and apply the migrations placed in the migration folder
        */
